...
class TrafficController:
    ...
    def has_found_position(self):
        return self.copter_state > self.STATE_IDLE
    ...
    def is_charging(self):
        return self.copter_state == self.STATE_WAIT_FOR_TAKE_OFF
    ...
    def is_charged_for_flight(self):
        return self.vbat > 3.00 #4.1 -> 3.50으로 수정 -> 3.00으로 수정
    ...
    def _log_data(self, timestamp, data, logconf):
        ...
        self.est_x = data['kalman.stateX']
        self.est_y = data['kalman.stateY']
...
class SyncTower(TowerBase):
    def __init__(self, uris, report_socket=None):
        ...
        self._start_position = [
            [   0 + master_offset[0],    0 + master_offset[1], 0], #8  2  6
            [   0 + master_offset[0],  0.5 + master_offset[1], 0], #5  1  4
            [   0 + master_offset[0], -0.5 + master_offset[1], 0], #7  3  9
